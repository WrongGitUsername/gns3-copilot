...
if dotenv_loaded:
    logger.info(
        "GNS3GetDrawingsTool Successfully loaded environment variables from .env file"
    )
else:
    logger.warning(
        "GNS3GetDrawingsTool No .env file found or failed to load. Using existing environment variables."
    )
